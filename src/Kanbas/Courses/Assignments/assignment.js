        ...
        <div className="row margin-top-20">
          <div className="col-md-8 assignment-container d-flex align-items-center custom-background custom-right-padding height">
            ...
            <div className="custom-left-padding">
              <button className="oval-button custom-background">
                40% of Total
              </button>
        ...
        <div className="row left-border">
          {courseAssignments.map((assignment) => (
            ...
            >
              <div className="d-flex align-items-center padding-top-10">
                ...
                <div
                  className="margin-bottom-20 margin-left"
          ...
          {showConfirmationDialog && (
            <div className="confirmation-dialog">
              ...
              <button className="btn btn-danger deleteButton" onClick={cancelDelete}>
                No
              </button>
              <button className="btn btn-light deleteButton" onClick={cancelDelete}>
                Cancel
              </button>
            </div>
          )}
